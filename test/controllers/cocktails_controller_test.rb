...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference("Cocktail.count") do
      post cocktails_url, params: { cocktail: { instruction: @cocktail.instruction, name: @cocktail.name } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { instruction: @cocktail.instruction, name: @cocktail.name } }
